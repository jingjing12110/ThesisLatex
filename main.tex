...
\title{基于图网络和多模态预训练模型的视觉问答方法研究}{Visual Question Answering\\ with Graph Networks and Multimodal Pretrained Models}
...
\addcommitteemember{西北工业大学,何明一,教授}
\addcommitteemember{西北工业大学,李学龙,教授}
\addcommitteemember{西安交通大学,陈霸东,教授}
\addcommitteemember{西安交通大学,袁泽剑,教授}
\addcommitteemember{西安交通大学,兰旭光,教授}


% 答辩时间（手动指定）
% Defence date, input manually
\defensedate{2023}{05}{18}

% 答辩地点（涉密论文请手动设置为「西安交通大学」）
% Defence location, default value is 「西安交通大学」
\defenseloc{西安交通大学科学馆324室}
...
\addgeneralreviewer{西北工业大学,何明一,教授}
\addgeneralreviewer{西北工业大学,李学龙,教授}
\addgeneralreviewer{西安交通大学,陈霸东,教授}
\addgeneralreviewer{西安交通大学,袁泽剑,教授}
\addgeneralreviewer{西安交通大学,兰旭光,教授}
% 学院
...
% X-GGM
\newcommand{\VQA}{\mathcal{{VQA}}}
\newcommand{\VQAR}{\mathcal{{VQA_R}}}
\newcommand{\VQAC}{\mathcal{{VQA_C}}}
...
\thesisbody{
    Main_Spine/command_math,
    Main_Spine/c0,
    Main_Spine/c1,
    Main_Spine/c2_LiVLR,
    Main_Spine/c3_XGGM,
    Main_Spine/c4_CIB,
    Main_Spine/c5_MixPHM,
    Main_Spine/c6
}
